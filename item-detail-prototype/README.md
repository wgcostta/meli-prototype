...
# Executar suite completa para CI
npm run test:ci
```
...
app/
├── __tests__/
│   └── page.integration.test.tsx    # Testes de integração
├── components/
│   └── __tests__/
│       ├── LoadingAndError.test.tsx # Testes de componentes
│       ├── ProductGallery.test.tsx
│       └── ProductInfo.test.tsx
├── hooks/
│   └── __tests__/
│       └── useProductApi.test.ts    # Testes de hooks
lib/
└── __tests__/
...
- **Next.js Image**: Componente otimizado
- **Next.js Router**: Navegação
- **Fetch API**: Requisições HTTP
- **IntersectionObserver**: Lazy loading
- **ResizeObserver**: Responsividade
...
# Relatório de cobertura interativo
node scripts/test-setup.js coverage

# Validar thresholds de cobertura
node scripts/test-setup.js validate

# Limpar artifacts de teste# MercadoClone - Página de Produto com API Integration
